...
class Colours {
    static let background = #colorLiteral(red: 0.08235294118, green: 0.1294117647, blue: 0.2352941176, alpha: 1)
    ...
    static let alertsColour = #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1)
